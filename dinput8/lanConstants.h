...
const unsigned long addresses[LAN_NUM_VERSIONS][NUM_OFFSETS] =
{
	// 2167 (retail)
	{
		...
		/* 0x00A7D26F */ 0x0067D26F, // OFFSET_FRAME_HOOK
		/* 0x00E1B17F */ 0x00A1B17F, // OFFSET_PATCH_CAR_BRAKE_CONSTANT
		/* 0x00D34E30 */ 0x00934E30, // OFFSET_PATCH_ASPECT_CHECK
		/* 0x01146380 */ 0x00D46380, // OFFSET_HOOK_FIELD_OF_VIEW_VTABLE
		/* 0x00A7FE77 */ 0x0067FE77, // OFFSET_HOOK_CREATE_WINDOW
		/* 0x00A7867C */ 0x0067867C, // OFFSET_PATCH_WINDOWED
		/* 0x009C087E */ 0x005C087E, // OFFSET_HOOK_RESOLUTION
	},
